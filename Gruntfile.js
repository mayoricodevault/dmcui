    ...
    grunt.initConfig({
        ...
        less: {
            dev_main: {
                ...
                files: {
                    '<%= pathDev %>/<%= pathAssets %>/css/appui.css': '<%= pathDev %>/<%= pathAssets %>/less/main.less'
                }
            },
            dev_themes: {
                options: {
            ...
            build: {
                ...
                files: {
                    '<%= pathBuild %>/<%= pathAssets %>/css/appui.min.css': '<%= pathDev %>/<%= pathAssets %>/less/main.less',
        ...
        concat: {
            ...
            build: {
                ...
                dest: '<%= pathBuild %>/<%= pathAssets %>/js/appui.min.js'
            }
        },
        uglify: {
            options: {
            ...
            build: {
                files: {
                    '<%= pathBuild %>/<%= pathAssets %>/js/appui.min.js': ['<%= pathBuild %>/<%= pathAssets %>/js/appui.min.js']
                }
            }
        },
        copy: {
